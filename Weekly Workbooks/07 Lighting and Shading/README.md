...
_Gouraud shading_ in one such intelligent approach to surface rendering. View the slides and audio narration above to gain an understanding of the principles of Gouraud shading and then using this knowledge, implement this approach in your renderer. In order to achieve this, you will need to make use of _Barycentric coordinates_ to interpolate vertex brightnesses across the face of each triangle. We introduced Barycentric coordinates in the 2nd workbook - you might like to revisit the animation provided there in order to refresh your memory. The animation linked to at the top of _this current_ section provides an additional perspective on the use of Barycentric coordinates in the interpolation of colour values that may also be useful.
